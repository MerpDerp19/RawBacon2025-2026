...
public class FarAutoRed extends LinearOpMode {
    ...
    private FarAutoRed.LaunchState launchState;
    ...
    private FarAutoRed.AutoState autoState;
...
*/
    ...
    public void runOpMode() throws InterruptedException {
        ...
        goToPosition(0 * COUNTS_PER_INCH,48 * COUNTS_PER_INCH, 0.5, -7, 0.5 * COUNTS_PER_INCH);
        ...
        goToPosition(0 * COUNTS_PER_INCH,0 * COUNTS_PER_INCH, 0.5, -7, 0.5 * COUNTS_PER_INCH);
        ...
        sleep(1000);
        goToPosition(6 * COUNTS_PER_INCH, 6 * COUNTS_PER_INCH,0.5, 10, 0.5 * COUNTS_PER_INCH);
