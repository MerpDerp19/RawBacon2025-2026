...
public class OdometryGlobalCoordinatePosition implements Runnable{
    ...
    private void globalCoordinatePositionUpdate(){
        //Get Current Positions                            offset encoder position by adding or subtracting tics.
        verticalLeftEncoderWheelPosition = ((verticalEncoderLeft.getCurrentPosition() + 527.279197) * verticalLeftEncoderPositionMultiplier);
