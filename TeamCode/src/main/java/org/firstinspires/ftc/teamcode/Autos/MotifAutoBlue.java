...
@Autonomous(name = "MotifAutoBlue")
public class MotifAutoBlue extends LinearOpMode {
    //Drive motors
    ...
    private MotifAutoBlue.LaunchState launchState;
    ...
    private MotifAutoBlue.AutoState autoState;
